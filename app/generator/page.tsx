  ...
  theme: {
    ...
    return (
        <div className="flex h-screen w-full bg-stone-50 overflow-hidden font-sans">
            ...
            {/* RIGHT CANVAS */}
            <main className="flex-1 relative flex items-center justify-center bg-[#FAFAF9] overflow-hidden">
                {/* Dot Grid Background */}
                <div
                ...
                {/* Content Area */}
                <div className={`relative z-10 transition-all duration-500 w-full h-full flex items-center justify-center ${isDarkMode ? 'dark' : ''}`}>
                    {brand ? (
                        <WorkbenchBentoGrid
                            brand={brand}
                            isDark={isDarkMode}
