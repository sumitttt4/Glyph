        ...
        <div className={cn("bg-stone-900/90 backdrop-blur-md border border-white/10 p-4 rounded-xl text-white w-64 shadow-2xl space-y-4", className)}>
            ...
            <div className="space-y-2 pb-2 border-b border-white/10">
                ...
                <div className="flex bg-black/20 rounded-lg p-1 gap-1">
                    <button
                        onClick={() => onUpdateBrand({ logoAssemblerLayout: 'stacked' })}
                        className={cn(
                            "flex-1 py-1.5 rounded-md flex items-center justify-center transition-all",
                            brand.logoAssemblerLayout === 'stacked' ? "bg-white text-stone-900 shadow-sm" : "hover:bg-white/10 text-white/60"
                        )}
                        title="Stacked"
                    >
                        <Rows size={14} />
                    ...
                    <button
                        onClick={() => onUpdateBrand({ logoAssemblerLayout: 'icon_left' })}
                        className={cn(
                            "flex-1 py-1.5 rounded-md flex items-center justify-center transition-all",
                            brand.logoAssemblerLayout === 'icon_left' ? "bg-white text-stone-900 shadow-sm" : "hover:bg-white/10 text-white/60"
                        )}
                        title="Horizontal"
                    >
                        <Columns size={14} />
                    ...
                    <button
                        onClick={() => onUpdateBrand({ logoAssemblerLayout: 'badge' })}
                        className={cn(
                            "flex-1 py-1.5 rounded-md flex items-center justify-center transition-all",
                            brand.logoAssemblerLayout === 'badge' ? "bg-white text-stone-900 shadow-sm" : "hover:bg-white/10 text-white/60"
                        )}
                        title="Badge"
                    >
                        <Square size={14} />
