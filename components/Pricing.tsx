                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-white border border-stone-200 rounded-xl overflow-hidden shadow-2xl h-full flex flex-col">
                            ...
                            <div className="bg-[#0C0A09] p-6 flex justify-between items-center text-white border-b border-stone-800 relative overflow-hidden">
                                ...
                                {/* RECOMMENDED Badge */}
                                <div className="absolute top-0 right-0 bg-[#FF4500] text-[10px] font-bold px-2 py-1 rounded-bl-lg text-white uppercase tracking-wide">
                                    Best Value
                                </div>

                                <div className="relative z-10">
                                    <h3 className="font-bold text-lg tracking-wide uppercase">Founder Pass</h3>
                                    <p className="text-stone-400 text-xs font-mono">EARLY ACCESS LICENSE</p>
                                </div>
                                <div className="relative z-10 text-right">
                                    <span className="block text-2xl font-bold text-orange-500">$19</span>
                                    <span className="text-stone-500 text-xs line-through decoration-red-500">$49</span>
                                </div>
                            </div>
