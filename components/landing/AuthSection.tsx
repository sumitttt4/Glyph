                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="w-full">
                            <SignInButton mode="modal">
                                <button className="w-full flex items-center justify-center gap-2 h-11 border border-zinc-200 bg-white rounded-lg hover:bg-zinc-50 text-zinc-700 transition-colors font-medium text-sm">
